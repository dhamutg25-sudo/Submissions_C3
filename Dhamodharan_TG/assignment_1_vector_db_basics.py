...
def load_documents_from_folder(folder_path: str):
    ...
    # Load documents using SimpleDirectoryReader with recursive parameter
...
def create_vector_index(documents: List, vector_store):
    ...
    # Create StorageContext with vector_store, then use VectorStoreIndex.from_documents
...
def search_documents(index, query: str, top_k: int = 3):
    ...
    # Perform semantic search using the index retriever
